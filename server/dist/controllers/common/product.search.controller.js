...
const Product_model_1 = require("../../models/Product.model"); // ✅ path adjust if file name differs
    ...
    try {
        ...
        const [items, total] = await Promise.all([
            Product_model_1.Product.find(filter)
                .select("_id title slug featureImage mrp salePrice totalStock baseStock variants ownerType vendorId approvalStatus")
                .sort({ createdAt: -1 })
                .skip(skip)
                .limit(limit)
                .lean(),
