...
export default function WebsiteUserLayout({
  ...
  const isActive = (href: string) => {
    if (href === "/website/user") return pathname === "/website/user";
  ...
  />
            ...
            <div className="p-2">
              ...
              <Link
                ...
                className={`block px-4 py-3 text-sm font-semibold transition ${
                  isActive("/website/user/dashboard")
                    ? "bg-gray-900 text-white"
                    : "text-gray-800 hover:bg-gray-50"
                }`}
              >
              ...
              <Link
                href="/website/user/addresses"
                className={`block px-4 py-3 text-sm font-semibold transition ${
                  isActive("/website/user/addresses")
                    ? "bg-gray-900 text-white"
                    : "text-gray-800 hover:bg-gray-50"
                }`}
              >
